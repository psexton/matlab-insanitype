%FROMJAVAINT Unit tests for an int return value
% We expect a Java int to be scalar, numeric, integer, and of type int32.
%
% Part of the Matlab-Insanitype project.

classdef FromJavaInt < TestCase
    properties
       value; % The variable coerced from a Java type
    end
    
    methods
        function obj = FromJavaInt(name)
            obj = obj@TestCase(name);
            obj.value = net.psexton.insanitype.FromJavaPrimitive.getInt();
        end
