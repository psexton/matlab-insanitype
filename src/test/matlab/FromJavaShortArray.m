%FROMJAVASHORTARRAY Unit tests for a short[] return value
% We expect a Java short to be scalar, numeric, integer, and of type int16.
%
% Part of the Matlab-Insanitype project.

classdef FromJavaShortArray < TestCase
    properties
       value; % The variable coerced from a Java type
    end
    
    methods
        function obj = FromJavaShortArray(name)
            obj = obj@TestCase(name);
            obj.value = net.psexton.insanitype.FromJavaPrimitiveArray.getShort();
        end
